...
const FAQS: FAQItem[] = [
  {
    ...
    a: "TransitOps is a smart transport operations platform that helps businesses manage vehicles, drivers, trip dispatch, maintenance, fuel expenses, and fleet performance from a single centralized dashboard.",
  },
  {
    q: "How does trip dispatch work?",
    a: "Create a trip by selecting a source, destination, available vehicle, and eligible driver. TransitOps automatically validates vehicle availability, driver eligibility, and cargo capacity before dispatching the trip.",
  },
  {
    q: "Can I track vehicle maintenance?",
    a: "Yes. TransitOps lets you schedule and manage maintenance records. Vehicles under maintenance are automatically marked as 'In Shop' and cannot be assigned to new trips until maintenance is completed.",
  },
  {
    q: "How does TransitOps improve fleet efficiency?",
    a: "TransitOps provides real-time visibility into vehicle utilization, fuel consumption, operational costs, and trip performance, helping organizations reduce downtime and optimize fleet operations.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Record fuel logs, maintenance costs, tolls, and other expenses for every vehicle. TransitOps automatically calculates operational costs and provides detailed reports for analysis.",
  },
  {
    q: "Is TransitOps suitable for small and large fleets?",
    a: "Yes. Whether you manage a handful of vehicles or an enterprise fleet, TransitOps scales to support your transport operations with centralized management and real-time insights.",
  },
  {
    q: "Does TransitOps support role-based access?",
      ...
      <div className="faq__inner">
        <div className="faq__header">
          ...
          <p className="faq__sub reveal-text" style={{ "--delay": SUBHEADING_DELAY } as React.CSSProperties}>
            Everything you need to know about TransitOps.<br />
